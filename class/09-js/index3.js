...
class Apartment extends House{
    ...
    // override (오버라이드) 부모의 메소드와 같은 함수를 재정의 할때
    getWindow(){
        return `${this.name} 아파트의 ${this.window} 개의 창문은
        ${this.windowMaker} 회사에서 생산되었습니다.`
    }
}
const Apartment1 = new Apartment(2022, '레미안', 3, 20, 'KCC');
console.log(Apartment1.getAptInfo()); 
console.log(Apartment1.getWindow());
